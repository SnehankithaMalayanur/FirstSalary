...
<h3 align=center><u>JobSeeker Profile</u></h3>
...
<form:form action="insertjobprofile" method="post" modelAttribute="jobprofile">
...
<td><form:input path="skill1" required="required"/></td>
</tr>
...
<td><form:input path="skill2" required="required"/></td>
</tr>
...
<td><form:input path="sscpercentage" required="required"/></td>
</tr>

<tr><td></td></tr>
<tr>
<td><label>Inter Percentage</label></td>
<td><form:input path="interpercentage" required="required"/></td>
</tr>
...
<td><form:input path="ugpercentage" required="required"/></td>
</tr>
...
<td><form:input path="linkedinurl" required="required"/></td>
</tr>
...
<td><form:input type="file" path="resume" required="required"/></td>
</tr>
...
<tr align=center>
<td colspan=2><input type="submit" value="Create Profile" class="button"></td>
</tr>
