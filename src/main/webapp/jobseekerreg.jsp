...
<ul>
  <li><a href="/">Home</a></li>
  <li><a class="active" href="jobseekerlogin">JobSeeker</a></li>
</ul>

<br><br>

<h3 align=center><u>JobSeeker Registration</u></h3>
...
<form:form action="addjobseeker" method="post" modelAttribute="jobseeker">
...
<td>
<form:select path="educationalqualification" required="required">
<form:option value="-1">---Select---</form:option>
<form:option value="Undergraduate">Undergraduate</form:option>
<form:option value="Graduate">Graduate</form:option>
<form:option value="High School">High School</form:option>
</form:select>
</td>
</tr>
...
<tr>
<td><label>Key Skills</label></td>
<td><form:input path="keyskills" required="required"/></td>
</tr>
...
<td><form:input path="workexperience" value="0.00" required="required"/></td>
</tr>
...
<td><form:input path="currentlocation" required="required"/></td>
</tr>
