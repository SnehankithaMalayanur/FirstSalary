...
<ul>
  ...
  <li><a href="viewjobseeker">View Profile</a></li>
  <li><a class="active" href="jobseekerchangepwd">Change Password</a></li>
...
<form method="post" action="updatejobseekerpwd">

<table align=center>

<tr>
<td><label>Old Password</label></td>
<td><input type="password" name="jobseekeropwd" required></td>
</tr>
...
<td><input type="password" name="jobseekernpwd" required></td>
</tr>
